       ...
       <center> Virus Detector </center>
		...
		<div class="row wf r2">
			<div class="col-md-4 lc">
				<form id="patientForm" class="wrap">
            	<!-- <center> -->
...
<script type="text/javascript">
    ...
    function uploadButton(base64String , uploadButton_element){
            ...
            xmlhttp.open("POST" , 'https://eu-gb.functions.cloud.ibm.com/api/v1/web/vmk0888%40gmail.com_dev/default/objectdetection.json', true)
            xmlhttp.setRequestHeader("content-type","application/json")
            xmlhttp.send(JSON.stringify({'img64String':base64String , 
